...
const AboutBottomSection = () => {
  return (
    <>
      <div className=" p-10 pb-60 bg-color-light-whitesmoke">
        <div className="largerDevices:max-w-7xl mx-auto flex flex-col gap-8 lg:flex-row justify-around items-center">
